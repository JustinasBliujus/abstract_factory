...
public class OrcShaman implements Character {
    private String name;
    private int health;
    private int attack;
    private int defense;
    ...
    public OrcShaman(String name, Weapon weapon, Armor armor) {
        this.name = name;
        this.health = 100;
        this.attack = 28;
        this.defense = 10;
    ...
    public String getDescription() {
        return "An Orc Shaman with " + weapon.getName() + " and " + armor.getName();
    }
}
